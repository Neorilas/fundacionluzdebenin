...
export async function generateMetadata({
  ...
  const title = isFr
    ? 'Ton Saint Missionnaire au Bénin | Fondation Lumière du Bénin'
    : 'Tu Santo Misionero en África | Fundación Luz de Benín';
  const description = isFr
    ? "Découvre quel saint missionnaire t'accompagne cette année dans la mission au Bénin. Attribution providentielle basée sur ton email. Partage avec tes amis."
