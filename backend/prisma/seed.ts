...
async function main() {
  ...
  const pageSections = [
    ...
    // Quiénes Somos — Timeline (8 slots numerados; vacíos se ocultan en el frontal)
    { page: 'quienes-somos', section: 'timeline-1', key: 'year', valueEs: '2012', valueFr: '2012' },
    { page: 'quienes-somos', section: 'timeline-1', key: 'event',
    ...
    { page: 'quienes-somos', section: 'timeline-2', key: 'year', valueEs: '2014', valueFr: '2014' },
    { page: 'quienes-somos', section: 'timeline-2', key: 'event',
      valueEs: 'Primer proyecto de construcción de escuela en Cotonou',
      valueFr: 'Premier projet de construction d\'école à Cotonou' },
    { page: 'quienes-somos', section: 'timeline-3', key: 'year', valueEs: '2016', valueFr: '2016' },
    { page: 'quienes-somos', section: 'timeline-3', key: 'event',
      valueEs: 'Ampliación del programa de salud materno-infantil',
      valueFr: 'Expansion du programme de santé materno-infantile' },
    { page: 'quienes-somos', section: 'timeline-4', key: 'year', valueEs: '2018', valueFr: '2018' },
    { page: 'quienes-somos', section: 'timeline-4', key: 'event',
      valueEs: 'Lanzamiento del programa de becas universitarias',
      valueFr: 'Lancement du programme de bourses universitaires' },
    { page: 'quienes-somos', section: 'timeline-5', key: 'year', valueEs: '2020', valueFr: '2020' },
    { page: 'quienes-somos', section: 'timeline-5', key: 'event',
      valueEs: 'Superamos los 1.000 beneficiarios directos anuales',
      valueFr: 'Plus de 1 000 bénéficiaires directs annuels' },
    { page: 'quienes-somos', section: 'timeline-6', key: 'year', valueEs: '2024', valueFr: '2024' },
    { page: 'quienes-somos', section: 'timeline-6', key: 'event',
    ...
    { page: 'quienes-somos', section: 'timeline-7', key: 'year', valueEs: '', valueFr: '' },
    { page: 'quienes-somos', section: 'timeline-7', key: 'event', valueEs: '', valueFr: '' },
    { page: 'quienes-somos', section: 'timeline-8', key: 'year', valueEs: '', valueFr: '' },
    { page: 'quienes-somos', section: 'timeline-8', key: 'event', valueEs: '', valueFr: '' },
