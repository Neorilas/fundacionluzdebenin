...
async function main() {
  ...
  const projects = [
    {
      slug: 'escuela-primaria-cotonou',
      titleEs: 'Escuela Primaria de Cotonou',
      titleFr: 'École Primaire de Cotonou',
      descEs: 'Construcción y equipamiento de una escuela primaria para 300 niños en el barrio de Akpakpa, Cotonou. El proyecto incluye 8 aulas, biblioteca, servicios y zona de recreo.',
      descFr: 'Construction et équipement d\'une école primaire pour 300 enfants dans le quartier d\'Akpakpa, Cotonou. Le projet comprend 8 salles de classe, une bibliothèque, des sanitaires et une aire de jeux.',
      status: 'completed',
      featured: true,
      images: JSON.stringify(['/uploads/project1.jpg']),
      stats: JSON.stringify({ children: 300, teachers: 12, classrooms: 8 }),
      order: 1,
    },
    {
      slug: 'centro-salud-rural-abomey',
      titleEs: 'Centro de Salud Rural en Abomey',
      titleFr: 'Centre de Santé Rural à Abomey',
      descEs: 'Ampliación y modernización del centro de salud de la aldea de Djidja, con nuevos equipos médicos, formación del personal y programa de salud materno-infantil.',
      descFr: 'Agrandissement et modernisation du centre de santé du village de Djidja, avec de nouveaux équipements médicaux, la formation du personnel et un programme de santé materno-infantile.',
      status: 'active',
      featured: true,
      images: JSON.stringify(['/uploads/project2.jpg']),
      stats: JSON.stringify({ patients: 1200, staff: 5, villages: 8 }),
      order: 2,
    },
    {
      slug: 'agricultura-sostenible-atacora',
      titleEs: 'Agricultura Sostenible en Atacora',
      titleFr: 'Agriculture Durable à l\'Atacora',
      descEs: 'Formación a 50 familias en técnicas de agricultura sostenible, acceso a semillas mejoradas y creación de una cooperativa agrícola local en la región de Atacora.',
      descFr: 'Formation de 50 familles aux techniques d\'agriculture durable, accès aux semences améliorées et création d\'une coopérative agricole locale dans la région de l\'Atacora.',
      status: 'active',
      featured: true,
      images: JSON.stringify(['/uploads/project3.jpg']),
      stats: JSON.stringify({ families: 50, hectares: 120, income: '+40%' }),
      order: 3,
    },
    {
      slug: 'becas-universitarias-2024',
      titleEs: 'Becas Universitarias 2024',
      titleFr: 'Bourses Universitaires 2024',
      descEs: 'Programa de becas para 20 jóvenes con escasos recursos económicos para acceder a estudios universitarios en Cotonou, con seguimiento y mentoría durante toda la carrera.',
      descFr: 'Programme de bourses pour 20 jeunes à faibles revenus pour accéder aux études universitaires à Cotonou, avec suivi et mentorat tout au long de leur cursus.',
      status: 'planned',
      featured: false,
      images: JSON.stringify([]),
      stats: JSON.stringify({ scholarships: 20, universities: 3 }),
      order: 4,
    },
  ];
